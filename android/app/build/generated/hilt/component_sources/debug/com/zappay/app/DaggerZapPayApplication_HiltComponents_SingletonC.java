...
public final class DaggerZapPayApplication_HiltComponents_SingletonC {
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          ...
          return (T) new CustomerViewModel(singletonCImpl.walletRepositoryProvider.get(), singletonCImpl.transactionRepositoryProvider.get(), singletonCImpl.qRRepositoryProvider.get());
  ...
  private static final class SingletonCImpl extends ZapPayApplication_HiltComponents.SingletonC {
    ...
    private void initialize(final ApplicationContextModule applicationContextModuleParam) {
      ...
      this.walletRepositoryProvider = DoubleCheck.provider(new SwitchingProvider<WalletRepository>(singletonCImpl, 6));
      this.transactionRepositoryProvider = DoubleCheck.provider(new SwitchingProvider<TransactionRepository>(singletonCImpl, 7));
      this.qRRepositoryProvider = DoubleCheck.provider(new SwitchingProvider<QRRepository>(singletonCImpl, 8));
      this.pumpRepositoryProvider = DoubleCheck.provider(new SwitchingProvider<PumpRepository>(singletonCImpl, 9));
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          ...
          case 4: // com.zappay.app.data.local.TokenManager 
